...
(function (angular) {
  ...
  angular.module('app')
    .directive('editpanelDirective', ['DataService', 'ModelHolderService', 'SchemaService', 'Utility', 'myValidatorService', function (ds, ModelHolderService, SchemaService, Utility, myValidatorService) {
